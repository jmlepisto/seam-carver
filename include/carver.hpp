...
namespace carver {
    ...
    /**
     * @brief The Carver class is responsible for all the mathematical operations needed for image carving
    ...
    public:
        ...
        /**
         * @brief removeVerticalSeam removes the given vertical seam from the source image and returns a reduced version
         * @param source source image
         * @param verticalSeam vertical seam indices
         * @return reduced target image
         */
        ...
        /**
         * @brief removeHorizontalSeam removes the given horizontal seam from the source image and returns a reduced version
         * @param source source image
         * @param horizontalSeam horizontal seam indices
         * @return reduced target image
         */
    ...
    private:
        ...
        /**
         * @brief findMinOffset locates the minimum entry from the given nexthop vector and returns an offset value
         * @param nextHops nexthop values
         * @return offset value: -1, 0 or 1.
         */
        int findMinOffset(vector<double> nextHops);
